			...
			<div class="board-table">
				<table class="table table-striped"
					...
					<c:if test = "${totCnt>0 }">
						...
						aria-expanded="false"><input type="hidden" id="reply${pcount.index}" value="${partyinfo.id}">${partyinfo.id}<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<!-- <li><a href="#">프로필보기</a></li> -->
							<c:if test="${id !=null && id != ''}">
								<li><a href="#" data-target="#writeModal" data-toggle="modal" onclick="reply(${pcount.index});">쪽지보내기</a></li>
							</c:if>
							<c:if test="${id ==null || id== ''}">
